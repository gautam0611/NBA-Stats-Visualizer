...
def get_conference(conference_id: schemas.Conference, db: Session = Depends(get_db)):
...
def get_all_teams(conference_id: schemas.Team, db: Session = Depends(get_db)):
...
def get_team(team_id: schemas.Team, conference_id: schemas.Team, db: Session = Depends(get_db)):
...
def get_record(record_id: schemas.Record, season_id: schemas.Season, team_id: schemas.Season, db: Session = Depends(get_db)):
...
def get_roster(roster_id: schemas.Roster, season_id: schemas.Season, team_id: schemas.Season, db: Session = Depends(get_db)):
...
def get_games(season_id: schemas.Games, team_id: schemas.Season, db: Session = Depends(get_db)):
